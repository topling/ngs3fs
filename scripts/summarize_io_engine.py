...
def html(data_by_suite, missing=()):
    out = [
        "<!doctype html><meta charset=\"utf-8\">",
        "<title>SQPOLL CPU comparison</title>",
        ...
        "<h1>I/O-engine CPU comparison</h1>",
